...
dataset_path = './dc_img_60000_1/epoch_410/g_all'
...
show_fid_mnist_hist(fid_hist, save=True, path='Anime_cGAN_results/Anime_cGAN_FID_hist_mnist.png')
show_fid_victim_hist(fid_hist, save=True, path='Anime_cGAN_results/Anime_cGAN_FID_hist_victim.png')
