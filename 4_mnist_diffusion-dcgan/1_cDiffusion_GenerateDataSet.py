...
def train_mnist():
            ...
            for w_i, w in enumerate(ws_test):
                ...
                if (ep+1)%check_epoch == 0:
                    ...
                    for label in range(10):
                        ...
                        for g in tqdm(range(picture_num_generate)):
    ...
    show_fid_hist(fid_hist, save=True, path='MNIST_diffusion_results/MNIST_cGAN_FID_hist.png')
